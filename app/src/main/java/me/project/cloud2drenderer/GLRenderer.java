...
public class GLRenderer implements GLSurfaceView.Renderer{
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
      ...
      //  scene.load( getCubeAssetBinding(0.5f,1,new float[]{0,0,-5}));
        ...
        scene.load(getBillboardAssetBinding(1, 1, new float[]{0.0f, 0.0f, -1f},new float[]{0,0,0}, pointLight));
        scene.load(getBillboardAssetBinding2(1f, 1f, new float[]{-1.3f, 0.0f, -1f},new float[]{0,0,0}, pointLight));
